...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    rules: [
      { id: 'PAGE-001', name: 'Title Page Not Numbered', description: 'The title page is page i but the number is not displayed.', autoFixable: true, severity: 'critical' },
      { id: 'PAGE-002', name: 'Copyright Page Not Numbered', description: 'The blank/copyright page is page ii but the number is not displayed.', autoFixable: true, severity: 'critical' },
      { id: 'PAGE-003', name: 'Approval Page Numbered iii', description: 'The approval page must always display the Roman numeral "iii".', autoFixable: true, severity: 'critical' },
      { id: 'PAGE-004', name: 'Preliminary Pages Use Roman Numerals', description: 'All preliminary pages (iii onward) must use lowercase Roman numerals.', autoFixable: true, severity: 'critical' },
      { id: 'PAGE-005', name: 'Body Pages Start at Arabic 1', description: 'The first page of the main body must be page 1, using Arabic numerals.', autoFixable: true, severity: 'critical' },
      { id: 'PAGE-006', name: 'Page Numbers Centered at Bottom', description: 'All page numbers must be centered at the bottom of the page.', autoFixable: true, severity: 'major' },
  ...
  },
  {
    ...
    rules: [
      ...
      { id: 'A11Y-002', name: 'Images Have Alt Text', description: 'All images and figures must have descriptive alternative text for screen readers. Placeholder alt text is added automatically.', autoFixable: true, severity: 'major' },
      { id: 'A11Y-003', name: 'Table Headers Marked', description: 'Tables must have header rows properly marked using Word\'s table header row feature. First rows are marked automatically.', autoFixable: true, severity: 'major' },
      ...
      { id: 'A11Y-005', name: 'Document Language Set', description: 'The document language must be explicitly set to English (or the applicable language) in Word. Set automatically to en-US.', autoFixable: true, severity: 'minor' },
      ...
      { id: 'A11Y-007', name: 'Reading Order / Tab Order', description: 'Floating text boxes and positioned objects must have alt text or be marked as decorative for screen readers.', autoFixable: false, severity: 'minor' },
      { id: 'A11Y-008', name: 'Bookmarks for Navigation', description: 'Document should have bookmarks or heading styles to enable screen reader navigation.', autoFixable: false, severity: 'minor' },
      { id: 'A11Y-009', name: 'No Flashing Content', description: 'No animated GIFs or flashing content that could trigger seizures (WCAG 2.3.1).', autoFixable: false, severity: 'major' },
      { id: 'A11Y-010', name: 'Color Not Sole Indicator', description: 'Color must not be the only visual means of conveying information (WCAG 1.4.1).', autoFixable: false, severity: 'minor' },
    ],
  },
];
